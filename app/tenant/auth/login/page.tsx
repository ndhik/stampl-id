    ...
    <div className="min-h-screen bg-[#F5F2EC] flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white border border-[#E8E2D8] rounded-2xl p-8">
          <h1 className="font-syne font-bold text-xl text-center mb-2">Masuk ke Dashboard</h1>
          <p className="text-xs text-[#888] text-center mb-6">Khusus pemilik bisnis</p>
          ...
          <form onSubmit={handleCredentials} className="space-y-4">
            <div>
              ...
              <Input id="email" type="email" value={email} onChange={e => setEmail(e.target.value)} className="mt-1" placeholder="email@bisnis.com" required />
            </div>
            <div>
